        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">
              Comprehensive analysis of all {tasks.length} maintenance tasks
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-900 mt-1">{formatCurrency(breakdown.totalCost)}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-purple-600 font-medium">Total Parts</p>
                  <p className="text-3xl font-bold text-purple-900 mt-1">{breakdown.totalParts}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-900 mt-1">{Object.keys(breakdown.byVehicle).length}</p>
                </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead>
                  <tr>
                    ...
                    <th className="px-4 py-3 text-right text-xs font-semibold text-gray-700 uppercase">Tasks</th>
                  ...
                  {Object.entries(breakdown.byVehicle)
                    ...
                    .map(([vehicleId, data], index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm font-medium text-gray-900">{data.registration}</td>
                        <td className="px-4 py-3 text-sm text-gray-900 text-right font-semibold">{data.count}</td>
                        <td className="px-4 py-3 text-sm text-gray-900 text-right">{formatCurrency(data.totalCost)}</td>
                      </tr>
                    ))}
                </tbody>
              </table>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <p className="text-sm text-gray-600 mr-4">
              Click on any category to filter the main task list
            </p>
            <button
