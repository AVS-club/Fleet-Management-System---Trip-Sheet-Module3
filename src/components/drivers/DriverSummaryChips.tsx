  ...
  return (
    <div className={`flex flex-wrap gap-2 ${className}`}>
      ...
      {driver.contact_number && (
        <div className="flex items-center bg-yellow-50 text-yellow-700 px-3 py-1.5 rounded-full text-xs md:text-sm">
      ...
      {/* Vehicle (if assigned) */}
      {vehicle && (
        <div className="flex items-center bg-red-50 text-red-700 px-3 py-1.5 rounded-full text-xs md:text-sm">
