...
const AdminTripsPage: React.FC = () => {
  ...
  // Format the selected date range as a user-friendly string
  const formattedDateRange = useMemo(() => {
    if (filters.dateRange.start && filters.dateRange.end) {
      return `${format(new Date(filters.dateRange.start), 'dd MMM yyyy')} - ${format(new Date(filters.dateRange.end), 'dd MMM yyyy')}`;
    }
    return '';
  }, [filters.dateRange]);
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm mb-6 sticky top-16 z-10">
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
              ...
              {/* Date Range - Combined into a single compact section */}
              <div className="relative">
                <div className="flex items-center">
                  ...
                  {formattedDateRange && datePreset !== 'custom' && (
                    <div className="ml-3 text-xs text-gray-600 flex items-center whitespace-nowrap">
                ...
                {/* Only show date inputs when custom is selected */}
                {datePreset === 'custom' && (
