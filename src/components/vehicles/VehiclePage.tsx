...
import { Truck, Calendar, PenTool as PenToolIcon, AlertTriangle, ChevronLeft, Fuel, FileText, Shield, Download, Share2, FileDown, Eye, Clock, Info, BarChart2, Database, IndianRupee, User, ExternalLink, MessageSquare } from 'lucide-react';
...
// Document Actions component to handle open, download, and share actions
...
const DocumentActions: React.FC<DocumentActionsProps> = ({ documentUrl, documentType, vehicleNumber }) => {
  ...
  const handleDownload = (e: React.MouseEvent) => {
    ...
    link.download = `${vehicleNumber}_${documentType.replace(/\s+/g, '_')}.pdf`;
  ...
  const handleShare = (e: React.MouseEvent) => {
    e.stopPropagation();
    const shareText = `View ${documentType} for ${vehicleNumber}: ${documentUrl}`;
  ...
  return (
    <div className="flex items-center space-x-2">
      <button 
        onClick={handleOpen}
        className="p-1 text-primary-600 hover:text-primary-800 hover:bg-primary-50 rounded-full transition-colors"
        title="Open document"
      >
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <DocumentActions 
                    documentUrl={signedDocUrls.rc} 
                    documentType="RC Document"
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <DocumentActions 
                    documentUrl={signedDocUrls.insurance} 
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <DocumentActions 
                    documentUrl={signedDocUrls.fitness} 
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <DocumentActions 
                    documentUrl={signedDocUrls.permit} 
                    documentType="Permit"
                    vehicleNumber={vehicle.registration_number}
                  />
                </div>
                  ...
                  {vehicle.other_documents.map((doc, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                      ...
                      {signedDocUrls.other[`other_${index}`] && (
                        <DocumentActions 
                          documentUrl={signedDocUrls.other[`other_${index}`]} 
                          documentType={doc.name || `Document ${index + 1}`}
                          vehicleNumber={vehicle.registration_number}
                        />
                      )}
                    </div>
