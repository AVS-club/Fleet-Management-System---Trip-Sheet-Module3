        ...
        <div className="space-y-6">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {signedDocUrls.rc.map((url, idx) => (
                          <a
                            ...
                            className="px-2 py-1 text-sm font-medium text-primary-600 hover:text-primary-700 bg-white rounded-md border border-primary-200 hover:bg-primary-50 flex items-center gap-1"
                            title={`View RC Document ${idx + 1}`}
                          >
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  <div className="flex flex-col">
                    ...
                    {vehicle.insurance_premium_amount && (
                      <p className="text-xs text-gray-500 mt-0.5 ml-6">
                        Premium: ₹
                        {vehicle.insurance_premium_amount.toLocaleString()}
                      </p>
                    )}
                  </div>
                      ...
                      <div className="flex gap-2 justify-center  flex-wrap">
                        {signedDocUrls.insurance.map((url, idx) => (
                          <a
                            ...
                            rel="noopener noreferrer"
                            className="px-2 py-1 text-sm font-medium text-primary-600 hover:text-primary-700 bg-white rounded-md border border-primary-200 hover:bg-primary-50 flex items-center gap-1"
                            title={`View Insurance Document ${idx + 1}`}
                          >
                            <Eye className="h-4 w-4" />
                            {`Insurance ${idx + 1}`}
                          </a>
                      ...
                      <div className="flex gap-2 justify-center  flex-wrap">
                        {signedDocUrls.fitness.map((url, idx) => (
                          <a
                            ...
                            rel="noopener noreferrer"
                            className="px-2 py-1 text-sm font-medium text-primary-600 hover:text-primary-700 bg-white rounded-md border border-primary-200 hover:bg-primary-50 flex items-center gap-1"
                            title={`View Fitness Document ${idx + 1}`}
                          >
                            <Eye className="h-4 w-4" />
                            {`Fitness ${idx + 1}`}
                          </a>
                  ...
                  <div className="flex flex-col">
                    ...
                    {vehicle.permit_number && (
                      <p className="text-xs text-gray-500 mt-1 ml-6">
                        ...
                        {vehicle.permit_type &&
                          ` (${
                            vehicle.permit_type.charAt(0).toUpperCase() +
                            vehicle.permit_type.slice(1)
                          })`}
                      </p>
                    )}
                    {vehicle.permit_expiry_date && (
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {signedDocUrls.permit.map((url, idx) => (
                          <a
                            ...
                            rel="noopener noreferrer"
                            className="px-2 py-1 text-sm font-medium text-primary-600 hover:text-primary-700 bg-white rounded-md border border-primary-200 hover:bg-primary-50 flex items-center gap-1"
                            title={`View Permit Document ${idx + 1}`}
                          >
                            <Eye className="h-4 w-4" />
                            {`Permit ${idx + 1}`}
                          </a>
                ...
                <div className="space-y-3">
                  ...
                  {vehicle.remind_service && (
                    <>
                      <div className="flex justify-between items-center p-2">
                        ...
                        <span className="text-sm font-medium">
                          {vehicle.service_reminder_days_before || "Default"}{" "}
                          days
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center p-2">
                        ...
                        <span className="text-sm font-medium">
                          {vehicle.service_reminder_km?.toLocaleString() ||
                            "Default"}{" "}
                          km
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center p-2">
                        ...
                        <span className="text-sm font-medium">
                          {vehicle.service_reminder_contact_id
                            ? "Yes"
                            : "Default Contact"}
                        </span>
                      </div>
                  ...
                  {!vehicle.remind_service && (
                    <div className="bg-gray-50 p-3 rounded-lg text-center">
                      <p className="text-sm text-gray-500">
                        Service reminders are disabled for this vehicle
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-4">
              ...
              {vehicle.vahan_last_fetched_at && (
                <span className="text-xs text-gray-500">
                  Last updated:{" "}
                  {new Date(vehicle.vahan_last_fetched_at).toLocaleString()}
                </span>
              )}
            </div>
              ...
              !vehicle.national_permit_number && (
                <div className="flex items-center justify-center py-8 bg-gray-50 rounded-lg mt-4">
                  ...
                  <span className="text-gray-500">
                    No additional information available for this vehicle
                  </span>
                </div>
              )}
            ...
            {vehicle.other_documents &&
              ...
              vehicle.other_documents.length > 0 && (
                <div className="mt-6">
                ...
                <dl className="space-y-1">
                  ...
                  {vehicle.insurance_idv && (
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm font-medium">
                        ₹{vehicle.insurance_idv.toLocaleString()}
                      </dd>
                    </div>
                  )}
                ...
                <dl className="space-y-1">
                  {vehicle.tax_amount && (
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm font-medium">
                        ₹{vehicle.tax_amount.toLocaleString()}
                      </dd>
                    </div>
                  )}
                  {vehicle.tax_period && (
                ...
                <dl className="space-y-1">
                  {vehicle.fitness_cost && (
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm font-medium">
                        ₹{vehicle.fitness_cost.toLocaleString()}
                      </dd>
                    </div>
                  )}
                  {vehicle.permit_cost && (
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm font-medium">
                        ₹{vehicle.permit_cost.toLocaleString()}
                      </dd>
                    </div>
                  )}
                  {vehicle.puc_cost && (
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm font-medium">
                        ₹{vehicle.puc_cost.toLocaleString()}
                      </dd>
                    </div>
                  )}
                </dl>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <ul className="mt-1 text-error-700 list-disc list-inside text-sm">
                    ...
                    {fitnessStatus.status === "expired" && (
                      <li>
                        Fitness certificate expired on{" "}
                    ...
                    {pucStatus.status === "expired" && (
                      <li>
                        PUC certificate expired on{" "}
                        {formatDate(vehicle.puc_expiry_date)}
                      </li>
                    )}
                  </ul>
                  <p className="mt-2 text-sm text-error-700">
                    Please update these documents to maintain compliance.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <ul className="mt-1 text-warning-700 list-disc list-inside text-sm">
                      ...
                      {fitnessStatus.status === "expiring" && (
                        <li>
                          Fitness certificate expires on{" "}
                          {formatDate(vehicle.fitness_expiry_date)}
                        </li>
                      )}
                      {permitStatus.status === "expiring" && (
                      ...
                      {pucStatus.status === "expiring" && (
                        <li>
                          PUC certificate expires on{" "}
                          {formatDate(vehicle.puc_expiry_date)}
                        </li>
                      )}
                    </ul>
                    <p className="mt-2 text-sm text-warning-700">
                      Please prepare for renewal soon.
                    </p>
                  </div>
                </div>
              </div>
