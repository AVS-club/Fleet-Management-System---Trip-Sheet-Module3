...
const DRIVER_COLS = 'id,name,license_number,contact_number,address,date_of_birth,date_of_joining,license_expiry,medical_certificate_expiry,aadhar_number,status,experience_years,salary,added_by,organization_id,created_at,updated_at,driver_photo_url,primary_vehicle_id,documents_verified,license_doc_url,aadhar_doc_url,police_doc_url,medical_doc_url';
