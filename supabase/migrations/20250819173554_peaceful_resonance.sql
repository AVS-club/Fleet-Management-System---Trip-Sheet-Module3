/*
  # Rename added_by to created_by in trips table
...
BEGIN
  IF EXISTS (
    ...
    WHERE table_name = 'trips' AND column_name = 'added_by'
  ) THEN
    ALTER TABLE public.trips RENAME COLUMN added_by TO created_by;
  END IF;
END $$;
