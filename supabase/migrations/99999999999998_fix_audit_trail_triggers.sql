-- ================================================================
-- FIX: Update log_audit_trail function to support organization_id
-- ================================================================
-- This migration fixes the audit trail logging to work with the new
-- organization_id NOT NULL constraint added by the previous migration.
-- Date: 2025-11-03
-- ================================================================

-- First, check if log_audit_trail function exists and update it
DO $$
BEGIN
  ...
  RAISE NOTICE 'Updated log_audit_trail function to support organization_id';
END $$;
...
-- ================================================================
-- Update validation triggers to pass organization_id
-- ================================================================

-- 1. Update validate_odometer_continuity function
...
BEGIN
  RAISE NOTICE '============================================';
  RAISE NOTICE 'Audit trail trigger fix migration completed';
  RAISE NOTICE 'log_audit_trail function now supports organization_id';
  RAISE NOTICE '============================================';
END $$;
...
-- NOTES:
-- ================================================================
-- 1. This migration updates the log_audit_trail function to accept organization_id
-- 2. It updates the validate_odometer_continuity trigger to pass organization_id
-- 3. Other triggers that call log_audit_trail will use the fallback logic to determine org_id
