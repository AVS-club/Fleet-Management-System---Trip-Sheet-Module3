/*
  # Fix maintenance_service_tasks table structure

  1. Changes
    - Update maintenance_service_tasks table to match frontend expectations
    - Remove vendor_id column reference in queries
    - Ensure tasks column exists and is properly typed
*/
