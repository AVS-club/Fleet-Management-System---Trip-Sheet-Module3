/*
  # Create maintenance_tasks_catalog table
  
  1. New Tables
    - `maintenance_tasks_catalog`
      - Stores predefined maintenance task categories and names
      - Used for task selection in maintenance forms
