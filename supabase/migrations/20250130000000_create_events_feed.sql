/*
  # Create events_feed table for Hero Feed
  
  This table stores all fleet events for the unified activity feed,
  including AI alerts, maintenance tasks, trips, documents, and KPIs.
  
  1. Schema Changes
    - Create events_feed table
