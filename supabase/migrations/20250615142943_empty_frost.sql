/*
  # Storage Bucket and Policies for Maintenance Bills

  1. New Storage
    - Create 'maintenance' storage bucket if it doesn't exist
    - Add policies for authenticated users to manage maintenance bill files
  
  2. Security
    - Add conditional checks to avoid errors if policies already exist
    - Ensure authenticated users can upload, read, update, and delete maintenance bills
*/
