-- Quick Database Setup Script for DocumentSummaryPanel Optimization
-- Run this script in your Supabase SQL Editor to set up the database optimizations
...
-- Test 1: Check if materialized view has data
SELECT COUNT(*) as total_vehicles FROM document_summary;
...
-- Test 3: Get fleet statistics
SELECT * FROM get_fleet_document_summary_stats();

-- Test 4: Check for expired documents
SELECT 
  registration_number,
  insurance_status,
  fitness_status,
